...
function aboutUs() {
  ...
  const { value, setfixedMsg, PageHeading, WhatsAppLink } =
    ...
    <section>
      <div className="dark:text-white text-black backdrop-blur-[70px]">
        ...
        <div className="mb-4 p-[1.25rem]">
          <h2 className="text-[1.1925rem] sm:text-xl capitalize mb-4">
            more about mannu dhaba
          </h2>
          <h2 className="mb-2 sm:w-[75%] mx-auto text-justify text-[1.1025rem] sm:text-[1.1325rem] font-semibold">
            Best Pure Veg Restaurant on the Indore-Bhopal Highway.
          </h2>
          <p
            ref={secondPRef}
            className="mb-2 sm:w-[75%] mx-auto text-justify text-[1.0325rem] sm:text-[1.0625rem]"
          >
              ...
              .map((char, charind) => (
                <span key={charind}>
                  <span
                    className={`${
                      value === "dark"
                        ? "dark-pCharSpan dark:text-[#606060]"
                        : "pCharSpan text-[rgb(96_96_96_/_38%)]"
                    } ${
                      char === "pure" ||
                      char === "Vegetarian" ||
                      char === "vegetarian" ||
                      char === "family-friendly" ||
                      char === "year" ||
                      char === "2000" ||
                      char === "atmoshphere"
                        ? "font-bold"

    ...
    return (
        <footer className={`relative p-[20px] backdrop-blur-[70px]`}>
            <div className='py-5 sm:px-5 grid gap-8'>
                <div className='grid sm:grid-cols-3 gap-6'>
                    ...
                    <div className=''>
                        ...
                        <div className="flex flex-col items-start gap-y-3">
                            <a className='flex items-center gap-1' href="https://maps.app.goo.gl/9fbqpbeUvJ6TfNWt6">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="17" height="17" color={useContext(counterContext).value === 'dark' ? 'white' : 'black'} fill="none">
                            ...
                            <div onClick={copyNumber} className='flex items-center gap-2 cursor-pointer'>
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="17" height="17" color={useContext(counterContext).value === 'dark' ? 'white' : 'black'} fill="none">
                ...
                <p className='text-center'><address>{`design & developed by`}</address><strong><a className='uppercase' href="https://ayushnagar-portfolio.netlify.app/">Ayush Nagar</a></strong></p>
                <div className='border rounded-full overflow-hidden'></div>
            </div>
